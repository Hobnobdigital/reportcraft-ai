...
export const metadata: Metadata = {
  ...
  description: "AI-powered data storytelling for marketing teams. Upload CSV/Excel data and get executive dashboards with charts, KPIs, and written narratives in seconds.",
};
